...
class HermiteQuinticSplines {
 public:
  ...
  void initialize();
  void push_back(double t, double y, double ydot, double yddot);
  void compute();
...
class HQSpln4Vec {
 public:
  ...
  void push_back(double t, const Eigen::VectorXd& Y,
                 const Eigen::VectorXd& Ydot, const Eigen::VectorXd& Yddot);
  void compute();
