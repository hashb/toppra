...
MinJerk_OneDimension::MinJerk_OneDimension(const Eigen::Vector3d& init,
...
void MinJerk_OneDimension::setParams(const Eigen::Vector3d& init,
                                     const Eigen::Vector3d& end,
                                     const double& time_start,
                                     const double& time_end) {
  // Set the Parameters
...
void MinJerk_OneDimension::printParameters() {
  ...
  // rossy_utils::pretty_print(init_cond, std::cout, "init_cond");
  // rossy_utils::pretty_print(end_cond, std::cout,  "end_cond");
  // rossy_utils::pretty_print(C_mat, std::cout, "Coeff_Matrix");
  // rossy_utils::pretty_print(C_mat_inv, std::cout, "C_mat_inv");

  // rossy_utils::pretty_print(a_coeffs, std::cout, "Coeff_Vector");
  // rossy_utils::pretty_print(bound_cond, std::cout, "Boundary Conditions");
}
